...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BackendAccess'
        db.create_table(u'post_office_backendaccess', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250)),
            ('host', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ...
            ('use_tsl', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'post_office', ['BackendAccess'])

        # Adding field 'Email.backend_access'
        db.add_column(u'post_office_email', 'backend_access',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post_office.BackendAccess'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BackendAccess'
        db.delete_table(u'post_office_backendaccess')

        # Deleting field 'Email.backend_access'
        db.delete_column(u'post_office_email', 'backend_access_id')
