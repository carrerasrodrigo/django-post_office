...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BackendAccess.limit_min'
        db.add_column(u'post_office_backendaccess', 'limit_min',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BackendAccess.total_sent_last_min'
        db.add_column(u'post_office_backendaccess', 'total_sent_last_min',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BackendAccess.last_time_sent'
        db.add_column(u'post_office_backendaccess', 'last_time_sent',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BackendAccess.limit_min'
        db.delete_column(u'post_office_backendaccess', 'limit_min')

        # Deleting field 'BackendAccess.total_sent_last_min'
        db.delete_column(u'post_office_backendaccess', 'total_sent_last_min')

        # Deleting field 'BackendAccess.last_time_sent'
        db.delete_column(u'post_office_backendaccess', 'last_time_sent')
    ...
    models = {
        ...
        u'post_office.backendaccess': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time_sent': ('django.db.models.fields.IntegerField', [], {}),
